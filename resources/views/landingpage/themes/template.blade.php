...
<!-- Mirrored from gardapangan.org/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Dec 2023 11:38:46 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link
        href="{{ asset('frontend/wp-content/themes/foodify/fonts.googleapis.com/cssbc66bc66.css?family=Poppins:300,400,500,600,700%7CRoboto+Slab:400,700') }}"
        rel="stylesheet" />

    <link rel="stylesheet" href="{{ asset('frontend/wp-content/themes/foodify/assets/css/font-awesome.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/wp-content/themes/foodify/assets/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/wp-content/themes/foodify/assets/css/xsIcon.css') }}" />
...
<body>
    ...
    {{-- Navigation Bar --}}
    @include('landingpage.themes.navbar')
            ...
            <div class="xs-footer-top-layer">
                <div class="row">
                    <div class="col-lg-4 col-md-6 footer-widget xs-pr-20">
                        <h3 class="widget-title" style="color: #ffa700">Foodify</h3>
                        <p>
                            Foodify merupakan sebuah food bank yang bertujuan menjadi
                            pusat koordinasi makanan surplus dan berpotensi terbuang, untuk
                            disalurkan kepada masyarakat pra-sejahtera.
                        </p>
                    </div>
                    <div class="col-lg-4 col-md-6 footer-widget">
                        <h3 class="widget-title" style="color: #ffa700">Tentang Kami</h3>
                    ...
                    <div class="col-lg-4 col-md-6 footer-widget">
                        <h3 class="widget-title" style="color: #ffa700">Kontak Kami</h3>
                        <ul class="xs-info-list">
                            <li>
                                <i class="fa fa-home bg-red"></i>Jalan Bandung 123, Kota Bandung
                            </li>
                            <li>
                                <i class="fa fa-phone bg-green"></i><a>0895337847614</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="xs-copyright-text">
                            <p>&copy; Copyright 2023 Foodify - All Right's Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/jquery-3.2.1.min.js') }}"></script>
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/plugins.js') }}"></script>
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('frontend/wp-content/themes/foodify/assets/js/jquery.countdown.min.js') }}"></script>
