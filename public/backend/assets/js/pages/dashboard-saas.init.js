...
var sparklineoptions4 = {
    ...
    map =
        ...
        new jsVectorMap({
            ...
            zoomButtons: !1,
            regionStyle: {
                initial: { fill: "#fff", fillOpacity: 0.1 },
                hover: { fillOpacity: 0.2 },
            },
            markerStyle: {
                initial: { fill: "#f56e6e", fillOpacity: 1 },
                hover: { fill: "#f56e6e", fillOpacity: 0.8 },
            },
            markers: [
    ...
    options = {
        ...
        stroke: { show: !0, curve: "smooth", width: [0, 4] },
...
options = {
    series: [44, 55, 67],
    chart: { height: 323, type: "radialBar" },
    plotOptions: {
        radialBar: {
            offsetY: 0,
            startAngle: 0,
