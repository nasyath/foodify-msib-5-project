...
}
{
    ...
    var barchartColors,
        ...
        sparklineoptions3 =
            (sparklinechart2.render(),
            {
                ...
                colors: (barchartColors =
                    getChartColorsArray("chart-sparkline3")),
                tooltip: {
                    fixed: { enabled: !1 },
                    x: { show: !1 },
                    y: {
        ...
        barchartColors =
            ...
            getChartColorsArray("basic_candlestick")),
        options = {
            series: [
                {
                    data: [
            ...
            chart: { type: "candlestick", height: 380, toolbar: { show: !1 } },
            fill: {
                type: "gradient",
                gradient: {
                    shade: "dark",
...
var options1 = {
        ...
        colors: (barchartColors = getChartColorsArray("chart-1")),
    ...
    chart1 = new ApexCharts(document.querySelector("#chart-1"), options1);
chart1.render();
options1 = {
    series: [{ data: [50, 15, 35, 62, 23, 56, 44, 12, 36, 9, 54] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-2")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [25, 35, 35, 89, 63, 25, 44, 12, 36, 9, 54] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-3")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [50, 15, 35, 34, 23, 56, 65, 41, 36, 41, 32] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-4")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [45, 53, 24, 89, 63, 60, 36, 50, 36, 32, 54] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-5")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [50, 15, 35, 62, 23, 56, 44, 12, 36, 9, 54] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-6")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [63, 41, 20, 34, 42, 62, 35, 42, 36, 21, 56] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-7")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [50, 15, 35, 62, 23, 56, 44, 12, 36, 9, 54] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-8")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-9")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
...
options1 = {
    series: [{ data: [63, 42, 25, 63, 24, 56, 44, 63, 36, 24, 30] }],
    chart: { type: "line", width: 120, height: 30, sparkline: { enabled: !0 } },
    colors: (barchartColors = getChartColorsArray("chart-10")),
    stroke: { curve: "smooth", width: 3 },
    tooltip: {
        fixed: { enabled: !1 },
        x: { show: !1 },
